...
public class DentistInfo extends AppCompatActivity {

    private static final String TITLE = " Dental Info" ;
    private Toolbar tb;
    private Uri uri;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dentist_info);
        tb = (Toolbar)findViewById(R.id.denTb);
        ...
        getSupportActionBar().setLogo(R.drawable.tool_tooth);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()){
            ...
            case R.id.mail:
                ...
                break;
            case R.id.dctr:
                startActivity(new Intent(DentistInfo.this, DentDoc.class));
                break;
            case R.id.repPrb:
                ...
                builder.setPositiveButton("Submit", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        Toast.makeText(DentistInfo.this, "Your Report Submitted", Toast.LENGTH_SHORT).show();
                    }
                });
