...
import cogentdatasolutions.mydoctorapp.information.PsychoDoc;

public class PsychoInfo extends AppCompatActivity {
    private Toolbar tb;
    private static final String TITLE = " Psychiatrist Info";
    private Uri uri;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setLogo(R.drawable.tool_psycho);
    }
    @Override
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()){
            ...
            case R.id.mail:
                ...
                break;
            case R.id.dctr:
                startActivity(new Intent(PsychoInfo.this, PsychoDoc.class));
                break;
            case R.id.repPrb:
                ...
                builder.setPositiveButton("Submit", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        Toast.makeText(PsychoInfo.this, "Your Report Submitted", Toast.LENGTH_SHORT).show();
                    }
                });
