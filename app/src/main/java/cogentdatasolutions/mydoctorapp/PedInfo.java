...
import cogentdatasolutions.mydoctorapp.information.PedDoc;

public class PedInfo extends AppCompatActivity {
    private Toolbar tb;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tb = (Toolbar)findViewById(R.id.pedTb);
        ...
        getSupportActionBar().setLogo(R.drawable.tool_ped);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()){
            ...
            case R.id.mail:
                ...
                break;
            case R.id.dctr:
                startActivity(new Intent(PedInfo.this, PedDoc.class));
                break;
            case R.id.repPrb:
                ...
                builder.setPositiveButton("Submit", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        Toast.makeText(PedInfo.this, "Your Report Submitted", Toast.LENGTH_SHORT).show();
                    }
                });
