...
import cogentdatasolutions.mydoctorapp.information.PhysicianDoc;

public class PhysicianInfo extends AppCompatActivity {
    private static final String TITLE = " Physician Info";
    private Toolbar tb;
    private Uri uri;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tb = (Toolbar)findViewById(R.id.phyTb);
        ...
        getSupportActionBar().setLogo(R.drawable.tool_phy);
    }
    @Override
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()){
            ...
            case R.id.mail:
                ...
                break;
            case R.id.dctr:
                startActivity(new Intent(PhysicianInfo.this, PhysicianDoc.class));
                break;
            case R.id.repPrb:
                ...
                builder.setPositiveButton("Submit", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        Toast.makeText(PhysicianInfo.this, "Your Report Submitted", Toast.LENGTH_SHORT).show();
                    }
                });
